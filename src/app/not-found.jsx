      ...
      <main id="main-content" className="capwise-not-found relative isolate overflow-hidden">
        ...
        <section className="mx-auto grid min-h-[72vh] max-w-[90rem] items-center gap-12 px-gutter py-section-lg lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-7 max-w-[11ch] font-display text-h1 font-semibold text-foreground">
          ...
          <div className="rounded-[1.8rem] border border-border bg-surface/82 p-6 shadow-[0_28px_90px_rgba(27,20,100,0.12)] backdrop-blur-xl sm:p-9 lg:col-span-5">
            ...
            <h2 className="mt-7 font-display text-h2 font-semibold text-foreground">Useful destinations</h2>
