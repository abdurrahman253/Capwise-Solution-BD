            ...
            <div className="grid gap-5 md:grid-cols-2">
              {regulatoryWatchTopics.map((topic, index) => (
                ...
                >
                  ...
                  <h2 className="mt-3 max-w-[22ch] font-display text-card font-semibold text-foreground">
                    {topic.title}
                  </h2>
          ...
          <div className="mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-10">
            <div className="grid gap-12 lg:grid-cols-12 lg:gap-14">
              <div className="lg:col-span-5">
                ...
                <h2 className="mt-4 max-w-[15ch] font-display text-h2 font-semibold text-foreground">
        ...
        <section className="bg-brand border-y border-white/8 py-16 text-white sm:py-24 lg:py-28">
          <div className="mx-auto grid max-w-[90rem] gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:gap-16 lg:px-10">
            <div className="lg:col-span-5">
              ...
              <h2 className="mt-5 max-w-[13ch] font-display text-h2 font-semibold text-white">
