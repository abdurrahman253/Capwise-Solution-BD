        ...
        <section className="bg-brand text-white">
          <div className="mx-auto grid min-h-[70vh] max-w-[90rem] gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-12 lg:items-end lg:px-10 lg:py-28">
            <div className="lg:col-span-8">
              ...
              <h1 className="mt-7 max-w-[12ch] font-display text-[clamp(2rem,3.5vw,3.2rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-white">Credibility is stronger when every word can be verified.</h1>
            </div>
        ...
        <section className="capwise-evidence py-16 sm:py-24 lg:py-28">
          <div className="mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-10">
            <div className="rounded-[1.8rem] border border-border bg-surface p-7 text-center shadow-[0_28px_90px_rgba(27,20,100,0.09)] sm:p-12 lg:p-16">
              ...
              <h2 className="mx-auto mt-4 max-w-[17ch] font-display text-[clamp(1.75rem,2.6vw,2.5rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-foreground">Verified client stories will appear here after approval.</h2>
