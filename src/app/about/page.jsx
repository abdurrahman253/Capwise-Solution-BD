      ...
      <main id="main-content">
        <section className="capwise-gateway relative isolate overflow-hidden border-b border-border py-16 sm:py-24 lg:py-32">
          ...
          <div className="mx-auto grid max-w-[90rem] gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:items-end lg:gap-14 lg:px-10">
            <div className="lg:col-span-8">
              ...
              <h1 className="mt-6 max-w-[12ch] font-display text-[clamp(2.4rem,4.4vw,4.6rem)] font-semibold leading-[0.91] tracking-[-0.075em] text-foreground">One coordinated advisory partner for complex business obligations.</h1>
            </div>
        ...
        <section className="bg-surface py-16 sm:py-24 lg:py-28">
          <div className="mx-auto grid max-w-[90rem] gap-5 px-4 sm:px-6 lg:grid-cols-2 lg:px-10">
            <article className="rounded-[1.7rem] bg-brand p-7 text-white shadow-[0_32px_95px_rgba(27,20,100,0.22)] sm:p-10 lg:p-12">
              ...
              <h2 className="mt-6 font-display text-[clamp(2.15rem,3.6vw,3.6rem)] font-semibold leading-[0.97] tracking-[-0.06em] text-white">Be the reliable partner behind confident, compliant growth.</h2>
            ...
            <article className="rounded-[1.7rem] border border-border bg-background p-7 sm:p-10 lg:p-12">
              ...
              <h2 className="mt-6 font-display text-[clamp(2.15rem,3.6vw,3.6rem)] font-semibold leading-[0.97] tracking-[-0.06em] text-foreground">A trusted one-stop advisory firm built on integrity and long-term relationships.</h2>
          ...
          <div className="mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-10">
            <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
              <div className="lg:col-span-5">
                ...
                <h2 className="mt-5 max-w-[11ch] font-display text-[clamp(2.15rem,3.6vw,3.6rem)] font-semibold leading-[0.94] tracking-[-0.065em] text-foreground">Strong advice is useful only when it can be acted on.</h2>
        ...
        <section className="bg-brand py-14 text-white sm:py-20 lg:py-24">
          <div className="mx-auto flex max-w-[90rem] flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-10">
            <div><p className="text-[0.62rem] font-bold uppercase tracking-[0.2em] text-accent">Meet the advisors</p><h2 className="mt-4 max-w-[16ch] font-display text-[clamp(2.15rem,3.6vw,3.6rem)] font-semibold leading-[0.96] tracking-[-0.06em] text-white">Specialist depth, shared responsibility.</h2></div>
