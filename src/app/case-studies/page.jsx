        ...
        <section className="capwise-evidence relative isolate overflow-hidden border-b border-border py-16 sm:py-24 lg:py-30">
          ...
          <div className="mx-auto grid max-w-[90rem] gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:items-end lg:gap-14 lg:px-10">
            <div className="lg:col-span-8">
              ...
              <h1 className="mt-6 max-w-[12ch] font-display text-[clamp(2rem,3.5vw,3.2rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-foreground">Proof should be verified before it becomes marketing.</h1>
            </div>
            ...
            {caseStudies.length ? (
              <div className="grid gap-5 lg:grid-cols-2">
                {caseStudies.map((study) => (
                  <article key={study.slug} className="rounded-[1.5rem] border border-border bg-background p-7 sm:p-9">
                    ...
                    <h2 className="mt-4 font-display text-[clamp(1.2rem,1.5vw,1.55rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-foreground">{study.title}</h2>
              ...
              <div className="grid gap-6 lg:grid-cols-12">
                <div className="rounded-[1.6rem] bg-brand p-7 text-white sm:p-10 lg:col-span-7">
                  ...
                  <h2 className="mt-4 max-w-[14ch] font-display text-[clamp(1.75rem,2.6vw,2.5rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-white">The page is ready. The proof must come from real work.</h2>
