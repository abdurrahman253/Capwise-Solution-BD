            ...
            {caseStudies.length ? (
              <div className="grid gap-5 lg:grid-cols-2">
                {caseStudies.map((study) => (
                  <article key={study.slug} className="rounded-[1.5rem] border border-border bg-background p-7 sm:p-9">
                    ...
                    <h2 className="mt-4 font-display text-card font-semibold text-foreground">{study.title}</h2>
              ...
              <div className="grid gap-6 lg:grid-cols-12">
                <div className="rounded-[1.6rem] bg-brand p-7 text-white sm:p-10 lg:col-span-7">
                  ...
                  <h2 className="mt-4 max-w-[14ch] font-display text-h2 font-semibold text-white">The page is ready. The proof must come from real work.</h2>
