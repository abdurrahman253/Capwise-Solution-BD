      ...
      <main id="main-content">
        <section className="relative overflow-hidden border-b border-border bg-background py-16 sm:py-24 lg:py-28">
          ...
          <div className="mx-auto grid max-w-[94rem] gap-8 px-5 sm:px-6 lg:grid-cols-12 lg:items-end lg:px-8 2xl:px-10">
            <div className="lg:col-span-8"><p className="text-[0.62rem] font-extrabold uppercase tracking-[0.2em] text-brand-blue">Capwise Insights</p><h1 className="mt-5 max-w-[12ch] font-display text-[clamp(2rem,3.5vw,3.2rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-foreground">Useful guidance. Less legal noise.</h1></div>
