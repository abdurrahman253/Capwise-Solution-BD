          ...
          <header className="border-b border-border bg-surface py-12 sm:py-16 lg:py-20">
            <div className="mx-auto max-w-[94rem] px-5 sm:px-6 lg:px-8 2xl:px-10">
              ...
              <div className="mt-8 grid gap-10 lg:grid-cols-12 lg:items-end">
                <div className="lg:col-span-7"><p className="text-[0.62rem] font-extrabold uppercase tracking-[0.19em] text-brand-blue">{insight.category}</p><h1 className="mt-4 max-w-[16ch] font-display text-[clamp(3rem,6.1vw,6.4rem)] font-semibold leading-[.92] tracking-[-.07em] text-foreground">{insight.heading || insight.title}</h1><p className="mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg sm:leading-9">{insight.description}</p></div>
