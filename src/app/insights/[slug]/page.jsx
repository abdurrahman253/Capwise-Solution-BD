  ...
  return (
    <>
      ...
      <main id="main-content" className="bg-background">
        <article>
          <header className="border-b border-border bg-surface py-section-md">
          ...
          <div className="mx-auto grid max-w-[94rem] gap-12 px-gutter py-section-md lg:grid-cols-12">
