...
export default function HomeHero() {
  ...
  return (
    <section
      ...
      className="relative -mt-[4.75rem] overflow-hidden bg-brand-navy text-white sm:-mt-[5rem] md:-mt-[5rem] lg:-mt-[6.1875rem]"
              ...
              <div className="relative mx-auto flex min-h-[36rem] max-w-[94rem] items-end px-gutter pb-12 pt-10 sm:min-h-[44rem] sm:pb-24 sm:pt-16 lg:min-h-[46rem] lg:items-center lg:pb-20 lg:pt-28 xl:min-h-[48rem]">
                <div className="capwise-hero-slide-copy max-w-[49rem]">
                  ...
                  <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                    <Link href={slide.href} className="group inline-flex min-h-12 items-center justify-between gap-6 rounded-full bg-brand-gold px-6 text-sm font-extrabold text-brand-navy transition hover:-translate-y-0.5 hover:bg-brand-gold-soft active:translate-y-0 active:bg-brand-gold-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-navy sm:justify-center">
                      Explore Service
                      <ArrowRight size={16} className="transition group-hover:translate-x-1" />
                    </Link>
                    <Link href="/contact" className="group inline-flex min-h-12 items-center justify-between gap-6 rounded-full border border-white/24 bg-white/[0.07] px-6 text-sm font-bold text-white backdrop-blur transition hover:-translate-y-0.5 hover:border-white/45 hover:bg-white/[0.12] active:translate-y-0 active:bg-white/[0.14] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2 focus-visible:ring-offset-brand-navy sm:justify-center">
