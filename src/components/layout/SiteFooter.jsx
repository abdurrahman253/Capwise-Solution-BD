...
export default function SiteFooter() {
  return <footer className="border-t border-white/10 bg-[#090d23] text-white"><div className="mx-auto max-w-[94rem] px-5 py-14 sm:px-6 sm:py-18 lg:px-8 lg:py-20 2xl:px-10">
    <div className="grid grid-cols-2 gap-x-6 gap-y-10 lg:grid-cols-12 lg:gap-10">
      <div className="col-span-2 lg:col-span-4"><BrandLogo compact tagline light /><h2 className="mt-7 max-w-[14ch] font-display text-[clamp(1.75rem,2.6vw,2.5rem)] font-semibold leading-[1.1] tracking-[-0.02em]">Accounting, tax, legal and compliance—connected.</h2><p className="mt-4 max-w-md text-sm leading-7 text-white/55">Professional advisory support for businesses operating in Bangladesh.</p></div>
